...
def filter_y_value(dict_data):
        ...
        for key, value in dict_data.items():
                ...
                if(float(csv_data[3]) > y_max or float(csv_data[3])< -y_max):
                       continue
                if(float(csv_data[3]< y_min)):
                        continue
...
if __name__ == "__main__":
        ...
        src_csv_path = '/home/xieyi/save_img/img_12/0822/y=2.6_x=5_y=7_487_699.csv'
        save_csv_path = '/home/xieyi/save_img/img_12/0822/y=2.6_x=5_y=6_y=4.5_487_699_filter.csv'
