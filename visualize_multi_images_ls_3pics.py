...
def main():
    ...
    img_dir = '\\\\LZDING\\share_lz2\\48_TJP\\car_key_point\\test_result\\10_projection\\demo_20190227\\result_key_car_441_front\\'
    
    #print 'img_dir+++++', img_dir
    seg_dir = '\\\\LZDING\\share_lz2\\48_TJP\\car_key_point\\test_result\\10_projection\\demo_20190227\\20190125_carpointL_0\\' 
    point_dir = '\\\\LZDING\\share_lz2\\48_TJP\\car_key_point\\test_result\\10_projection\\demo_20190227\\result_key_car_441_right_rename\\'
    #blend_dir = 'missImage/'
    save_dir = '\\\\LZDING\\share_lz2\\48_TJP\\car_key_point\\test_result\\10_projection\\demo_20190227\\3pics\\'
    print(img_dir)
    ...
    for im_name in im_names:
        ...
        resImg = np.zeros((768,1280,3))
        image = cv2.resize(image, (1280, 384))
        seg_im = cv2.resize(seg_im, (640, 384))
        ...
        point_im = cv2.resize(point_im, (640, 384))
        print 'image.shape = ', image.shape
        resImg[0:384,0:1280,:] = image[:,:,:]
        resImg[384:768,0:640,:] = seg_im[:,:,:]
        resImg[384:768,640:1280,:] = point_im[:,:,:]
